export const courseData = [
    ...
    {
        image: '/src/assets/images/jira.png',
        name: 'Jira Essentials',
        category: 'DevOps',
        description: 'Learn how to use Jira for project management and agile development.',
        time: 20
    },
    {
        ...
        name: 'AWS Basics',
        category: 'DevOps',
        description: 'Get started with Amazon Web Services and deploy your applications to the cloud.',
        time: 8
    },
    {
        image: '/src/assets/images/azure.png',
        name: 'Azure Fundamentals',
        category: 'DevOps',
        description: 'Learn the basics of Microsoft Azure and deploy your applications to the cloud.',
        time: 8
    },
    {
    ...
    },
    {
        ...
        description: 'Learn the key principles of Scrum and agile project management.',
        time: 4
    },
    {
        ...
        category: 'Agile Methodologies',
        description: 'Get started with Kanban and visualize your workflow.',
        time: 4
    },
    {
        image: '/src/assets/images/lean.png',
